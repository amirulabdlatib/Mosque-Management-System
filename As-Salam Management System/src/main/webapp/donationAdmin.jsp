 ...
 <section class="donation" id="view1">
    ...
    <p class="w3-opacity"><i>“Sedekah dapat menghapus dosa sebagaimana air memadamkan api.” <br>(Riwayat al-Tirmizi)</i></p>
    	...
    	<c:forEach items="${donationList}" var="donate">
    			<tr>
    				<td><c:out value="${donate.donationID}"></c:out></td>
    				<td><c:out value="${donate.userID}"></c:out></td>
    				...
    				<td><a href="ViewDonationController?donationID=<c:out value="${donate.donationID}"/>">View</a></td>
				    <td><a href="UpdateDonationServlet?donationID=<c:out value="${donate.donationID}"/>">Update</a></td>
				    <td><a href="DeleteDonationController?donationID=<c:out value="${donate.donationID}"/>">Delete</a></td>
			...
			<div class="container-button">
  				<div class="center-button">
    				...
    				<button onclick="location.href='addDonate.jsp'">&nbsp;Register Donation&nbsp;</button>
  				</div>
			</div>
</section>
