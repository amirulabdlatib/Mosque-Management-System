  ...
  <header>
        <div class="container">
            ...
            <div class="nav-btn">
                    ...
                    <ul>
                            ...
                            <div class="dropdown">
                                <ul>
                                    <li class="dropdown-link">
                                        <a href="ListDonationServletAdmin">Manage</a>
                                    </li>
                                    <li class="dropdown-link">
                                        <a href="#view1">View</a>
                                    </li>
                        ...
                        <li class="nav-link" style="--i: 1.1s">
                            ...
                            <div class="dropdown">
                                <ul>
                                    <li class="dropdown-link">
                                        <a href="ListEventServletAdmin">Manage</a>
                                    </li>
                                    <li class="dropdown-link">
                                        <a href="#view2">View</a>
                                    </li>
                ...
                <div class="log-sign">
                	<img src="images/user.png" class="logo" width="30" height="30"></img>
                    <div class="username" style="color:white"><%
                    String username = (String) session.getAttribute("username");
                    int userid = (int) session.getAttribute("userid");
                    %>
                    &nbsp;<%=username%>&nbsp;&nbsp;</div>
                    <a href="userS" class="btn solid">Logout</a>   
                </div>
            </div>
    ...
    <p class="w3-opacity"><i>ìSedekah dapat menghapus dosa sebagaimana air memadamkan api.î <br>(Riwayat al-Tirmizi)</i></p>
			...
			<div class="container-button">
  				<div class="center-button">
    				<button onclick="location.href='ListDonationServletAdmin'">&nbsp;View Donation&nbsp;</button>
  				</div>
			</div>
...
<button onclick="location.href='ListDonationServletAdmin'">Read More</button>
</div>
</div>
<!--cards -->
...
<div class="container-button">
  				<div class="center-button">
  					<button onclick="location.href='ListEventServletAdmin'">&nbsp;View Events&nbsp;</button>
  				</div>
			</div>
...
<div class="des">
 <p>24 August 2022</p>
<button onclick="location.href='ListEventServletAdmin'">Read More</button>
</div>
</div>
<!--cards -->
