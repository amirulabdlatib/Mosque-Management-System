...
<html>
  ...
  <body>
    <section>
    	...
    	<div class="contentBx">
    		<div class="formBx">
    			<h2>Mosque registration</h2>
    			<form action="mosqueS" method="post">
    				<div class="inputBx">
    					<div class="insert">
    						<i class="fas fa-mosque"></i>
    						<input id="mId" type="number" name="name" placeholder="Mosque ID" required="required">
    					</div>
    				</div>
    				<div class="inputBx">
    					<div class="insert">
    						<i class="fas fa-pen"></i>
	  						<input id="mName" type="text" name="name" placeholder="Mosque name" required="required">
    					</div>
    				</div>
    				<div class="inputBx">
    					<div class="insert">
    						<i class="fas fa-address-card"></i>
	  						<input id="mNumber" type="text" name="name" placeholder="Phone number" required="required">
    					</div>
    				</div>
    				<div class="inputBx">
    					<div class="insert">
    						<i class="fas fa-search-location"></i>
	  						<input id="mAddress" type="text" name="name" placeholder="Mosque address" required="required">
    					</div>
    				</div>
    				<div class="inputBx">
